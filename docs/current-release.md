...
Last checked: 2026-05-23 16:13 Asia/Shanghai.
...
- Working branch: `codex/room-render-production-minimum`
- Current public runtime baseline: Tencent `a1a0465 fix: keep mobile room entry actions visible`; Render `13389e0 fix: keep mobile room entry actions visible`
- Local worktree at runtime check: `codex/mobile-room-lobby` pushed to GitHub; Render deploy branch pushed to `origin/codex/room-render-production-minimum`
- Render deployment branch at last check: `13389e0 fix: keep mobile room entry actions visible`
...
- Latest deployed branch head at last check: `13389e0 fix: keep mobile room entry actions visible`
...
Result at 2026-05-23 16:12 Asia/Shanghai: `ok=true`, all production minimum checks passed.
...
Result at 2026-05-23 16:12 Asia/Shanghai: `ok=true`, room `ZLKCIJ`, host seat `1`, guest seat `2`.

Latest room action smoke:

```powershell
$env:ROOM_SMOKE_BASE_URL="https://ai-werewolf-free.onrender.com"; npm run smoke:room-action:vote
```

Result at 2026-05-23 16:13 Asia/Shanghai: `ok=true`, room `JGSI3R`, covered `wolfKill`, `speak`, and `vote`; vote resolved into `LAST_WORDS`.
